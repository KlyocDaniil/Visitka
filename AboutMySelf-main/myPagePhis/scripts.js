...
//LIKE POST (WILL FIX)
// let LikePost = document.getElementById('LikePostF');
// let placeForLikes = document.getElementById('likes_cnt')
// let counter =0;
// LikePost.addEventListener('click',()=>{
//     counter +=1;
//     placeForLikes.innerText = `Кол-во лайков = ${counter}`
// })
...
openPopUp.addEventListener('click',function (e){
    e.preventDefault(); // уберем ненужное поведение кнопки
